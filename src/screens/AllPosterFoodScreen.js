...
import AllPosterFood from '../components/AllPosterFood';


const AllPosterFoodScreen = ({ navigation, route }) => {
        ...
        <View className="flex-1 bg-white">
            <SafeAreaView>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomColor: 'rgba(0, 0, 0, 0.1)', borderBottomWidth: 2, backgroundColor: '#FFFFFF', paddingBottom: 10, paddingTop: 10 }}>
                    ...
                    <Text style={{ fontSize: 20, paddingLeft: 20, color: '#4A4A4A', flex: 8 }}>Cách làm</Text>
                </View>
                <AllPosterFood iduser={iduser} />
            </SafeAreaView>
        </View>
    )
}

export default AllPosterFoodScreen